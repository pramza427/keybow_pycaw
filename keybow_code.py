# Copy and paste this into the code.py file in the CIRCUITPY directory (Keybow)

# There are three layers, selected by pressing and holding key 3 (top left), 
# then tapping one of the coloured layer selector keys to the right of it

# The layer colours are as follows:

#  * layer 1: pink: F13 - F24 used for pycaw media controls and - = \ that I use for discord mute defen and overlay respectively
...
# keycodes to be picked up by pycaw_on_startup.py for audio adjustments
        ...
        if keys[k].pressed:
            ...
            if not fired:
                ...
                if current_layer == 7:
                    ...
                    keyboard.send(Keycode.LEFT_ALT, key_press)
